...
import 'package:weather_forecast/ui/detail_page.dart';
import 'package:weather_forecast/widgets/weather_items.dart';
...
class _HomeState extends State<Home> {
  ...
  String imageUrl = '';
  int woeid = 1; // This is the Where on Earth Id for Mumbai, our default city
  String location = 'Mumbai'; // Our default city

  // Get the cities and selected cities data
  var selectedCities = City.getSelectedCities();
  List<String> cities = [
    'Mumbai'
  ]; // The list to hold our selected cities. Default is Mumbai

  List consolidatedWeatherList = []; // To hold our weather data after API call

  // API calls URL
  String searchLocationUrl =
      'https://api.weatherpublicindia.com/location/search/?query='; // To get the woeid
  String searchWeatherUrl =
      'https://api.weatherpublicindia.com/location/'; // To get weather details using the woeid
                      ...
                      return GestureDetector(
                        ...
                        child: Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              Text(
                                "${consolidatedWeatherList[index]['the_temp'].round()}C",
                                style: TextStyle(
                                  fontSize: 17,
                                  color: selectedDay == today
                                      ? Colors.white
  ...
  void fetchWeatherData() async {
    ...
    setState(() {
      ...
      // The index 0 refers to the first entry which is the current day. The next day will be index 1, second day index 2 etc...
      ...
      consolidatedWeatherList = consolidatedWeather
          .toSet()
          .toList(); // Remove any instances of duplicates from our
